...
export type CourseCategory = 'coding' | 'design' | 'robotics' | 'stem' | 'language' | 'game';
...
export const courseCategoryCounts: Array<{
  key: CourseCategory | 'all';
  label: string;
  count: number;
}> = [
  { key: 'all', label: 'All', count: 18 },
  { key: 'coding', label: 'Coding', count: 8 },
  { key: 'design', label: 'Design', count: 3 },
  { key: 'robotics', label: 'Robotics', count: 2 },
  { key: 'stem', label: 'STEM', count: 3 },
  { key: 'language', label: 'Language', count: 2 }
];
